    ...
    HT.createVariantRow = (attributeItem, variantItem) => {
        ...
        $td = $('<td>').append(
            $('<span>').addClass('image img-cover').append(
                $('<img>').attr('src', '/laravelversion1.com/public/backend/img/not_found.jpg').addClass('imageSrc')
            )
        )
        $row.append($td)
    ...
    HT.productVariant = () => {
        ...
        $('.variant-row').each(function (index, value) {
            ...
            if (dataIndex !== -1) {
                ...
                let variantImage = (album) ? album.split(',')[0] : '/laravelversion1.com/public/backend/img/not_found.jpg'
