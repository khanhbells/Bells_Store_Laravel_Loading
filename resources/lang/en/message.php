...
return [
    ...
    'galleryCatalogue' => [
        'index' => [
            'title' => 'Image Group Management',
            'table' => 'Image Group List',
        ],
        'create' => [
    ...
    'generalDescription' => '- Are you sure you want to delete:',
    'danger' => '- Warning: Be cautious when deleting as data cannot be recovered!',
];
