            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p class="text-danger">- Bạn có chắc chắn muốn xóa tài khoản: {{ $user->email }} </p>
                        <p class="text-danger">- Lưu ý: Nếu xóa tài khoản bạn không thể đăng nhập bằng tài khoản này
                            được nữa. </p>
                    </div>
                </div>
            </div>
