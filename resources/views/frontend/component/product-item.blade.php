...
<div class="product-item product">
    ...
    <a href="" class="image img-cover"><img
            src="{{ asset('frontend/resources/img/product-' . rand(1, 10) . '.jpg') }}" alt=""></a>
    <div class="info">
    ...
    <div class="tools">
        ...
        <a href="" title=""><img src="{{ asset('frontend/resources/img/wishlist.svg') }}"
                alt=""></a>
        <a href="" title=""><img src="{{ asset('frontend/resources/img/compare.svg') }}"
                alt=""></a>
        <a href="#popup" data-uk-modal title=""><img src="{{ asset('frontend/resources/img/view.svg') }}"
                alt=""></a>
    </div>
</div>
